...
import { Brain, FileText, Heart, MessageCircle, Shield, Users } from 'lucide-react';
...
const Psicologia = ({ nomeProfissional, reservaIds, pendingReservas }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <SectionTitle><Brain size={18} /> 1. Motivo da Busca</SectionTitle>
      <Grid>
      ...
      <SectionTitle><Shield size={18} /> 2. Histórico Psicológico</SectionTitle>
      <Grid>
        <Field>
      ...
      <SectionTitle><Shield size={18} /> 3. Medicamentos Psiquiátricos</SectionTitle>
      <Grid>
        <Field>
      ...
      <SectionTitle><Heart size={18} /> 4. Saúde Emocional Atual</SectionTitle>
      <Grid>
        <Field>
      ...
      <SectionTitle><Users size={18} /> 5. Contexto de Vida</SectionTitle>
      <Grid>
        <Field>
      ...
      <SectionTitle><MessageCircle size={18} /> 6. Eventos e Experiências</SectionTitle>
      <Grid>
        <Field>
      ...
      <SectionTitle><Brain size={18} /> 7. Objetivos com a Terapia</SectionTitle>
      <Grid>
        <Field style={{ gridColumn: '1 / -1' }}>
      ...
      <SectionTitle><FileText size={18} /> 8. Observações</SectionTitle>
      <Grid>
        <Field style={{ gridColumn: '1 / -1' }}>
